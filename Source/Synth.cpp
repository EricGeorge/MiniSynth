    ...
    layout.add(std::make_unique<AudioProcessorParameterGroup>("AmpEnvelopeGroupID", "Amp Envelope", "/",
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_Attack],
                                                                                                    ...
                                                                                                    NormalisableRange<float> (envAttackMinValue,
                                                                                                                              envAttackMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, 0.5, 1000.0);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, 0.5, 1000.0);}),
