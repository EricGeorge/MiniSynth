    ...
    layout.add(std::make_unique<AudioProcessorParameterGroup>("AmpEnvelopeGroupID", "Amp Envelope", "/",
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_Attack],
                                                                                                    ...
                                                                                                    NormalisableRange<float> (envAttackMinValue,
                                                                                                                              envAttackMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, envAttackAnchorPoint, envAttackAnchorValue);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, envAttackAnchorPoint, envAttackAnchorValue);}),
                                                              ...
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_Decay],
                                                                                                    ...
                                                                                                    NormalisableRange<float> (envDecayMinValue,
                                                                                                                              envDecayMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, envDecayAnchorPoint, envDecayAnchorValue);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, envDecayAnchorPoint, envDecayAnchorValue);}),
                                                              ...
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_Release],
                                                                                                    ...
                                                                                                    NormalisableRange<float> (envReleaseMinValue,
                                                                                                                              envReleaseMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, envReleaseAnchorPoint, envReleaseAnchorValue);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, envReleaseAnchorPoint, envReleaseAnchorValue);}),
                                                                                                    envReleaseInitialValue),
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_AttackCurve],
                                                                                                    "Attack Curve",
                                                                                                    NormalisableRange<float> (envAttackCurveMinValue,
                                                                                                                              envAttackCurveMaxValue,
                                                                                                    ...
                                                                                                    envAttackCurveInitialValue),
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_DecayCurve],
                                                                                                    "Decay Curve",
                                                                                                    NormalisableRange<float> (envDecayCurveMinValue,
                                                                                                                              envDecayCurveMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, 0.5, 1.0);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, 0.5, 1.0);}),
                                                                                                    envDecayCurveInitialValue),
                                                              std::make_unique<AudioParameterFloat>(envelope_ParamIDs[kEnvParam_ReleaseCurve],
                                                                                                    "Release Curve",
                                                                                                    NormalisableRange<float> (envReleaseCurveMinValue,
                                                                                                                              envReleaseCurveMaxValue,
                                                                                                                              [](float start, float end, float value) { return convertToRangeWithAnchor(start, end, value, 0.5, 1.0);},
                                                                                                                              [](float start, float end, float value) { return convertFromRangeWithAnchor(start, end, value, 0.5, 1.0);}),
                                                                                                    envReleaseCurveInitialValue)));
